...
_RULES = [
    ...
    # ---- Devanagari Hindi: FN-coverage patterns (from benchmark analysis) ----
    r"सभी नियम (अनदेखा|नज़रअंदाज़) करो",
    r"(ऊपर की|पहले के|पिछले) (सभी )?(बातें|निर्देश|नियम) (भूल जाओ|ध्यान मत दो|अनदेखा करो)",
    r"अपने (निर्देश|नियम|दिशानिर्देश) (ओवरराइड|हटाओ|भूल जाओ)",
    r"सिस्टम प्रॉम्प्ट (को )?(अनदेखा|बताओ|प्रकट|क्या है)",
    r"नया आदेश",
    r"बिना फ़िल्टर के",
