...
_FRAME_PATTERNS = [
    ...
    # ---- Devanagari framing: FN-coverage patterns (from benchmark analysis) ----
    r"ढोंग करो (तुम|कि)",
    r"काल्पनिक रूप से",
    r"कल्पना करो (तुम|कि|एक)",
    r"रोल-?प्ले करते हैं",
    r"एक ऐसी दुनिया की कल्पना",
    r"शोध के लिए.{0,20}(बायपास|अनदेखा)",
    r"तुम्हारे कोई (नैतिक |)प्रतिबंध नहीं",
